...
par(mfrow = c(2,3))
plot(x_agg1, k_agg1, ylim = c(0, 25), xlim = c(5, 25), ylab = 'Number of Argentine', xlab = 'Temperature',title('Aggregation 1 over 3 Days'))
abline(mod_agg1, lwd=2)
plot(x_agg2, k_agg2, ylim = c(0, 25), xlim = c(5, 25), ylab = 'Number of Argentine', xlab = 'Temperature',title('Aggregation 2 over 3 Days'))
abline(mod_agg2, lwd=2)
plot(x_agg3, k_agg3, ylim = c(0, 25), xlim = c(5, 25), ylab = 'Number of Argentine', xlab = 'Temperature',title('Aggregation 3 over 3 Days'))
abline(mod_agg3, lwd=2)
plot(x_day1, k_day1, ylim = c(0, 25), xlim = c(5, 25), ylab = 'Number of Argentine', xlab = 'Temperature',title('Day 1 for all 3 Aggregations'))
abline(mod_day1, lwd=2)
plot(x_day2, k_day2, ylim = c(0, 25), xlim = c(5, 25), ylab = 'Number of Argentine', xlab = 'Temperature',title('Day 2 for all 3 Aggregations'))
abline(mod_day2, lwd=2)
plot(x_day3, k_day3, ylim = c(0, 25), xlim = c(5, 25), ylab = 'Number of Argentine', xlab = 'Temperature',title('Day 3 for all 3 Aggregations'))
